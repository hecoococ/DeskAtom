const zh = {
  app: {
    ...
    aiSplitTitle: 'AI 智能拆分',
    aiSplitInput: '拆分输入内容',
    aiSplitTask: '拆分此任务',
    aiSplitLoading: '正在拆分任务...',
    aiSplitError: 'AI 拆分失败',
    aiSplitEmpty: '请先输入需要拆分的内容',
    aiSplitPrepare: '编辑发送内容',
    aiSplitPromptText: '发送给 AI 的内容',
    aiSplitPromptPlaceholder: '可以在这里补充背景、约束、不要猜测的信息等...',
    aiSplitCountRequirement: '希望拆分成多少个任务',
    aiSplitCountNone: '无要求',
    aiSplitCountApprox: '大约',
    aiSplitCountExact: '准确',
    aiSplitCountUnit: '个任务',
    aiSplitSend: '开始拆分',
    aiSplitBackToEdit: '返回编辑',
    aiSplitPreview: '拆分预览',
    aiSplitExplanation: '拆分说明',
    aiSplitSupplementInfo: '补充信息',
    aiSplitSupplementPlaceholder: '例如：不要添加我没写的日期；把采购相关内容合并；忽略已经完成的部分...',
    aiSplitRegenerate: '补充后重新拆分',
    aiSplitTarget: '写入目标',
    aiSplitNewGroup: '新建分组',
    aiSplitCurrentGroup: '并入当前分组',
    aiSplitExistingGroup: '选择已有分组',
    aiSplitGroupName: '分组名称',
    aiSplitTasks: '拆分任务',
    aiSplitCompleteSource: '完成原任务',
    aiSplitApply: '创建任务',
    aiSplitConfigHint: '请先在设置中配置 AI 服务',
    aiSplitRemoveTask: '移除任务'
  },
  settings: {
    title: '设置',
    darkMode: '暗夜模式',
    ...
    aiApiKeyPlaceholder: '请输入 OpenAI 兼容 API Key',
    aiModelLabel: '模型',
    aiModelPlaceholder: 'gpt-4o-mini',
    fillAIBaseURL: '请填写 AI Base URL',
    fillAIApiKey: '请填写 AI API Key',
    fillAIModel: '请填写 AI 模型名称',
...
const en = {
  app: {
    ...
    aiSplitTitle: 'AI Split',
    aiSplitInput: 'Split Input',
    aiSplitTask: 'Split This Task',
    aiSplitLoading: 'Splitting tasks...',
    aiSplitError: 'AI split failed',
    aiSplitEmpty: 'Please enter text to split first',
    aiSplitPrepare: 'Edit Prompt',
    aiSplitPromptText: 'Content sent to AI',
    aiSplitPromptPlaceholder: 'Add context, constraints, and anything the AI should not guess...',
    aiSplitCountRequirement: 'Desired number of tasks',
    aiSplitCountNone: 'No preference',
    aiSplitCountApprox: 'About',
    aiSplitCountExact: 'Exactly',
    aiSplitCountUnit: 'tasks',
    aiSplitSend: 'Split Tasks',
    aiSplitBackToEdit: 'Back to Edit',
    aiSplitPreview: 'Split Preview',
    aiSplitExplanation: 'Explanation',
    aiSplitSupplementInfo: 'Additional Info',
    aiSplitSupplementPlaceholder: 'For example: do not invent dates; merge purchasing items; ignore already-finished parts...',
    aiSplitRegenerate: 'Regenerate with Info',
    aiSplitTarget: 'Target',
    aiSplitNewGroup: 'New Group',
    aiSplitCurrentGroup: 'Current Group',
    aiSplitExistingGroup: 'Existing Group',
    aiSplitGroupName: 'Group Name',
    aiSplitTasks: 'Split Tasks',
    aiSplitCompleteSource: 'Complete source task',
    aiSplitApply: 'Create Tasks',
    aiSplitConfigHint: 'Please configure AI service in Settings first',
    aiSplitRemoveTask: 'Remove task'
  },
  settings: {
    title: 'Settings',
    darkMode: 'Dark Mode',
    ...
    aiBaseURLPlaceholder: 'https://api.openai.com/v1',
    aiApiKeyLabel: 'API Key',
    aiApiKeyPlaceholder: 'Enter OpenAI-compatible API Key',
    aiModelLabel: 'Model',
    aiModelPlaceholder: 'gpt-4o-mini',
    fillAIBaseURL: 'Please fill in AI Base URL',
    fillAIApiKey: 'Please fill in AI API Key',
    fillAIModel: 'Please fill in AI model',
    aiConfigSaved: 'AI config saved',
    aiConfigSaveFailed: 'Failed to save AI config',
    loadAIConfigFailed: 'Failed to load AI config:'
  },
  focusMode: {
